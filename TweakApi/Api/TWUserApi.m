...
@implementation TWUserApi

NSString* kTWUserApiErrorDomain = @"TWUserApiErrorDomain";
NSInteger kTWUserApiMissingParamErrorCode = 234513;
...
-(NSNumber*) userConfirmWithUid: (NSString*) uid
    ...
    if (uid == nil) {
        ...
        if(handler) {
            ...
            NSError* error = [NSError errorWithDomain:kTWUserApiErrorDomain code:kTWUserApiMissingParamErrorCode userInfo:userInfo];
            handler(error);
        }
        return nil;
    }
    ...
    NSMutableString* resourcePath = [NSMutableString stringWithFormat:@"/Users/confirm"];
...
-(NSNumber*) userCountWithWhere: (NSString*) where
    ...
    NSMutableString* resourcePath = [NSMutableString stringWithFormat:@"/Users/count"];
...
-(NSNumber*) userCreateChangeStreamGetUsersChangeStreamWithOptions: (NSString*) options
    ...
    NSMutableString* resourcePath = [NSMutableString stringWithFormat:@"/Users/change-stream"];
...
-(NSNumber*) userExistsGetUsersidExistsWithId: (NSString*) _id
    ...
    NSMutableString* resourcePath = [NSMutableString stringWithFormat:@"/Users/{id}/exists"];
...
-(NSNumber*) userFindWithFilter: (NSString*) filter
    ...
    return [self.apiClient requestWithPath: resourcePath
                        ...
                        requestContentType: requestContentType
                       responseContentType: responseContentType
                              responseType: @"NSArray<TWUser>*"
                           completionBlock: ^(id data, NSError *error) {
                                if(handler) {
                                    handler((NSArray<TWUser>*)data, error);
                                }
                           }
          ];
}
...
-(NSNumber*) userFindOneWithFilter: (NSString*) filter
    completionHandler: (void (^)(TWUser* output, NSError* error)) handler {
    NSMutableString* resourcePath = [NSMutableString stringWithFormat:@"/Users/findOne"];
...
-(NSNumber*) userPrototypeCountAccessTokensWithId: (NSString*) _id
    ...
    NSMutableString* resourcePath = [NSMutableString stringWithFormat:@"/Users/{id}/accessTokens/count"];
...
-(NSNumber*) userPrototypeCreateAccessTokensWithId: (NSString*) _id
    ...
    NSMutableString* resourcePath = [NSMutableString stringWithFormat:@"/Users/{id}/accessTokens"];
...
-(NSNumber*) userPrototypeDestroyByIdAccessTokensWithId: (NSString*) _id
    ...
    NSMutableString* resourcePath = [NSMutableString stringWithFormat:@"/Users/{id}/accessTokens/{fk}"];
...
-(NSNumber*) userReplaceByIdWithId: (NSString*) _id
    ...
    NSMutableString* resourcePath = [NSMutableString stringWithFormat:@"/Users/{id}/replace"];
...
-(NSNumber*) userReplaceOrCreateWithData: (TWUser*) data
    completionHandler: (void (^)(TWUser* output, NSError* error)) handler {
    NSMutableString* resourcePath = [NSMutableString stringWithFormat:@"/Users/replaceOrCreate"];
...
-(NSNumber*) userResetPasswordWithOptions: (NSObject*) options
    ...
    NSMutableString* resourcePath = [NSMutableString stringWithFormat:@"/Users/reset"];
...
-(NSNumber*) userUpdateAllWithWhere: (NSString*) where
    ...
    NSMutableString* resourcePath = [NSMutableString stringWithFormat:@"/Users/update"];
...
-(NSNumber*) userUpsertWithWhereWithWhere: (NSString*) where
    data: (TWUser*) data
    completionHandler: (void (^)(TWUser* output, NSError* error)) handler {
    NSMutableString* resourcePath = [NSMutableString stringWithFormat:@"/Users/upsertWithWhere"];
