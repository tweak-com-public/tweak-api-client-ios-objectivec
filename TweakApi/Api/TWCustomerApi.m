...
@interface TWCustomerApi ()

@property (nonatomic, strong) NSMutableDictionary *defaultHeaders;

@end

@implementation TWCustomerApi

NSString* kTWCustomerApiErrorDomain = @"TWCustomerApiErrorDomain";
NSInteger kTWCustomerApiMissingParamErrorCode = 234513;
...
+ (instancetype)sharedAPI {
    static TWCustomerApi *sharedAPI;
...
-(NSNumber*) customerConfirmWithUid: (NSString*) uid
    ...
    if (uid == nil) {
        ...
        if(handler) {
            ...
            NSError* error = [NSError errorWithDomain:kTWCustomerApiErrorDomain code:kTWCustomerApiMissingParamErrorCode userInfo:userInfo];
            handler(error);
        }
        return nil;
    }
    ...
    NSMutableString* resourcePath = [NSMutableString stringWithFormat:@"/Customers/confirm"];
...
-(NSNumber*) customerCountWithWhere: (NSString*) where
    ...
    NSMutableString* resourcePath = [NSMutableString stringWithFormat:@"/Customers/count"];
...
-(NSNumber*) customerCreateWithData: (TWCustomer*) data
    ...
    return [self.apiClient requestWithPath: resourcePath
                        ...
                        requestContentType: requestContentType
                       responseContentType: responseContentType
                              responseType: @"TWCustomer*"
                           completionBlock: ^(id data, NSError *error) {
                                if(handler) {
                                    handler((TWCustomer*)data, error);
                                }
                           }
          ];
}
...
-(NSNumber*) customerCreateChangeStreamGetCustomersChangeStreamWithOptions: (NSString*) options
    ...
    NSMutableString* resourcePath = [NSMutableString stringWithFormat:@"/Customers/change-stream"];
...
-(NSNumber*) customerExistsGetCustomersidExistsWithId: (NSString*) _id
    ...
    NSMutableString* resourcePath = [NSMutableString stringWithFormat:@"/Customers/{id}/exists"];
...
-(NSNumber*) customerFindWithFilter: (NSString*) filter
    ...
    return [self.apiClient requestWithPath: resourcePath
                        ...
                        requestContentType: requestContentType
                       responseContentType: responseContentType
                              responseType: @"NSArray<TWCustomer>*"
                           completionBlock: ^(id data, NSError *error) {
                                if(handler) {
                                    handler((NSArray<TWCustomer>*)data, error);
                                }
                           }
          ];
}
...
-(NSNumber*) customerFindOneWithFilter: (NSString*) filter
    completionHandler: (void (^)(TWCustomer* output, NSError* error)) handler {
    NSMutableString* resourcePath = [NSMutableString stringWithFormat:@"/Customers/findOne"];
...
-(NSNumber*) customerLoginWithCredentials: (NSObject*) credentials
    ...
    if (credentials == nil) {
        ...
        if(handler) {
            NSDictionary * userInfo = @{NSLocalizedDescriptionKey : [NSString stringWithFormat:NSLocalizedString(@"Missing required parameter '%@'", nil),@"credentials"] };
            NSError* error = [NSError errorWithDomain:kTWCustomerApiErrorDomain code:kTWCustomerApiMissingParamErrorCode userInfo:userInfo];
            handler(nil, error);
        }
        return nil;
    ...
    NSMutableString* resourcePath = [NSMutableString stringWithFormat:@"/Customers/login"];
...
-(NSNumber*) customerLogoutWithCompletionHandler: 
    ...
    NSMutableString* resourcePath = [NSMutableString stringWithFormat:@"/Customers/logout"];
...
-(NSNumber*) customerPrototypeCountAccessTokensWithId: (NSString*) _id
    ...
    NSMutableString* resourcePath = [NSMutableString stringWithFormat:@"/Customers/{id}/accessTokens/count"];
...
-(NSNumber*) customerPrototypeCountDesignsWithId: (NSString*) _id
    ...
    NSMutableString* resourcePath = [NSMutableString stringWithFormat:@"/Customers/{id}/designs/count"];
...
-(NSNumber*) customerPrototypeCreateAccessTokensWithId: (NSString*) _id
    ...
    NSMutableString* resourcePath = [NSMutableString stringWithFormat:@"/Customers/{id}/accessTokens"];
    ...
    return [self.apiClient requestWithPath: resourcePath
                        ...
                        requestContentType: requestContentType
                       responseContentType: responseContentType
                              responseType: @"TWAccessToken*"
                           completionBlock: ^(id data, NSError *error) {
                                if(handler) {
                                    handler((TWAccessToken*)data, error);
                                }
                           }
          ];
}
...
-(NSNumber*) customerPrototypeCreateDesignsWithId: (NSString*) _id
    ...
    NSMutableString* resourcePath = [NSMutableString stringWithFormat:@"/Customers/{id}/designs"];
    ...
    return [self.apiClient requestWithPath: resourcePath
                        ...
                        requestContentType: requestContentType
                       responseContentType: responseContentType
                              responseType: @"TWDesign*"
                           completionBlock: ^(id data, NSError *error) {
                                if(handler) {
                                    handler((TWDesign*)data, error);
                                }
                           }
          ];
}
...
-(NSNumber*) customerPrototypeDestroyByIdAccessTokensWithId: (NSString*) _id
    ...
    if (fk == nil) {
        NSParameterAssert(fk);
        if(handler) {
            NSDictionary * userInfo = @{NSLocalizedDescriptionKey : [NSString stringWithFormat:NSLocalizedString(@"Missing required parameter '%@'", nil),@"fk"] };
            NSError* error = [NSError errorWithDomain:kTWCustomerApiErrorDomain code:kTWCustomerApiMissingParamErrorCode userInfo:userInfo];
            handler(error);
        }
        return nil;
    ...
    NSMutableString* resourcePath = [NSMutableString stringWithFormat:@"/Customers/{id}/accessTokens/{fk}"];
...
-(NSNumber*) customerPrototypeDestroyByIdDesignsWithId: (NSString*) _id
    ...
    NSMutableString* resourcePath = [NSMutableString stringWithFormat:@"/Customers/{id}/designs/{fk}"];
...
-(NSNumber*) customerPrototypeGetAccessTokensWithId: (NSString*) _id
    ...
    return [self.apiClient requestWithPath: resourcePath
                        ...
                        requestContentType: requestContentType
                       responseContentType: responseContentType
                              responseType: @"NSArray<TWAccessToken>*"
                           completionBlock: ^(id data, NSError *error) {
                                if(handler) {
                                    handler((NSArray<TWAccessToken>*)data, error);
                                }
                           }
          ];
}
...
-(NSNumber*) customerPrototypeGetDesignsWithId: (NSString*) _id
    ...
    return [self.apiClient requestWithPath: resourcePath
                        ...
                        requestContentType: requestContentType
                       responseContentType: responseContentType
                              responseType: @"NSArray<TWDesign>*"
                           completionBlock: ^(id data, NSError *error) {
                                if(handler) {
                                    handler((NSArray<TWDesign>*)data, error);
                                }
                           }
          ];
}
...
-(NSNumber*) customerReplaceByIdWithId: (NSString*) _id
    ...
    NSMutableString* resourcePath = [NSMutableString stringWithFormat:@"/Customers/{id}/replace"];
...
-(NSNumber*) customerReplaceOrCreateWithData: (TWCustomer*) data
    completionHandler: (void (^)(TWCustomer* output, NSError* error)) handler {
    NSMutableString* resourcePath = [NSMutableString stringWithFormat:@"/Customers/replaceOrCreate"];
...
-(NSNumber*) customerResetPasswordWithOptions: (NSObject*) options
    ...
    NSMutableString* resourcePath = [NSMutableString stringWithFormat:@"/Customers/reset"];
...
-(NSNumber*) customerUpdateAllWithWhere: (NSString*) where
    ...
    NSMutableString* resourcePath = [NSMutableString stringWithFormat:@"/Customers/update"];
...
-(NSNumber*) customerUpsertWithWhereWithWhere: (NSString*) where
    data: (TWCustomer*) data
    completionHandler: (void (^)(TWCustomer* output, NSError* error)) handler {
    NSMutableString* resourcePath = [NSMutableString stringWithFormat:@"/Customers/upsertWithWhere"];
