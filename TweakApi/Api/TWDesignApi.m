...
@interface TWDesignApi ()

@property (nonatomic, strong) NSMutableDictionary *defaultHeaders;

@end

@implementation TWDesignApi

NSString* kTWDesignApiErrorDomain = @"TWDesignApiErrorDomain";
NSInteger kTWDesignApiMissingParamErrorCode = 234513;
...
-(NSNumber*) designCountWithWhere: (NSString*) where
    ...
    NSMutableString* resourcePath = [NSMutableString stringWithFormat:@"/Designs/count"];
...
-(NSNumber*) designCreateWithData: (TWDesign*) data
    ...
    NSMutableString* resourcePath = [NSMutableString stringWithFormat:@"/Designs"];
...
-(NSNumber*) designCreateChangeStreamGetDesignsChangeStreamWithOptions: (NSString*) options
    ...
    NSMutableString* resourcePath = [NSMutableString stringWithFormat:@"/Designs/change-stream"];
...
-(NSNumber*) designDeleteByIdWithId: (NSString*) _id
    ...
    if (_id == nil) {
        ...
        if(handler) {
            ...
            NSError* error = [NSError errorWithDomain:kTWDesignApiErrorDomain code:kTWDesignApiMissingParamErrorCode userInfo:userInfo];
            handler(nil, error);
        }
        return nil;
    }

    NSMutableString* resourcePath = [NSMutableString stringWithFormat:@"/Designs/{id}"];
...
-(NSNumber*) designExistsGetDesignsidExistsWithId: (NSString*) _id
    ...
    NSMutableString* resourcePath = [NSMutableString stringWithFormat:@"/Designs/{id}/exists"];
...
-(NSNumber*) designFindOneWithFilter: (NSString*) filter
    completionHandler: (void (^)(TWDesign* output, NSError* error)) handler {
    NSMutableString* resourcePath = [NSMutableString stringWithFormat:@"/Designs/findOne"];
...
-(NSNumber*) designPrototypeCountCategoriesWithId: (NSString*) _id
    ...
    NSMutableString* resourcePath = [NSMutableString stringWithFormat:@"/Designs/{id}/categories/count"];
...
-(NSNumber*) designPrototypeCountTagsWithId: (NSString*) _id
    ...
    NSMutableString* resourcePath = [NSMutableString stringWithFormat:@"/Designs/{id}/tags/count"];
...
-(NSNumber*) designPrototypeCreateCategoriesWithId: (NSString*) _id
    ...
    NSMutableString* resourcePath = [NSMutableString stringWithFormat:@"/Designs/{id}/categories"];
    ...
    return [self.apiClient requestWithPath: resourcePath
                        ...
                        requestContentType: requestContentType
                       responseContentType: responseContentType
                              responseType: @"TWCategory*"
                           completionBlock: ^(id data, NSError *error) {
                                if(handler) {
                                    handler((TWCategory*)data, error);
                                }
                           }
          ];
}
...
-(NSNumber*) designPrototypeCreateTagsWithId: (NSString*) _id
    ...
    NSMutableString* resourcePath = [NSMutableString stringWithFormat:@"/Designs/{id}/tags"];
...
-(NSNumber*) designPrototypeDestroyByIdCategoriesWithId: (NSString*) _id
    ...
    NSMutableString* resourcePath = [NSMutableString stringWithFormat:@"/Designs/{id}/categories/{fk}"];
...
-(NSNumber*) designPrototypeDestroyByIdTagsWithId: (NSString*) _id
    ...
    NSMutableString* resourcePath = [NSMutableString stringWithFormat:@"/Designs/{id}/tags/{fk}"];
...
-(NSNumber*) designPrototypeGetCategoriesWithId: (NSString*) _id
    ...
    return [self.apiClient requestWithPath: resourcePath
                        ...
                        requestContentType: requestContentType
                       responseContentType: responseContentType
                              responseType: @"NSArray<TWCategory>*"
                           completionBlock: ^(id data, NSError *error) {
                                if(handler) {
                                    handler((NSArray<TWCategory>*)data, error);
                                }
                           }
          ];
}
...
-(NSNumber*) designPrototypeGetCustomerWithId: (NSString*) _id
    ...
    NSMutableString* resourcePath = [NSMutableString stringWithFormat:@"/Designs/{id}/customer"];
...
-(NSNumber*) designReplaceByIdWithId: (NSString*) _id
    ...
    NSMutableString* resourcePath = [NSMutableString stringWithFormat:@"/Designs/{id}/replace"];
...
-(NSNumber*) designReplaceOrCreateWithData: (TWDesign*) data
    completionHandler: (void (^)(TWDesign* output, NSError* error)) handler {
    NSMutableString* resourcePath = [NSMutableString stringWithFormat:@"/Designs/replaceOrCreate"];
...
-(NSNumber*) designUpdateAllWithWhere: (NSString*) where
    ...
    NSMutableString* resourcePath = [NSMutableString stringWithFormat:@"/Designs/update"];
...
-(NSNumber*) designUpsertWithWhereWithWhere: (NSString*) where
    data: (TWDesign*) data
    completionHandler: (void (^)(TWDesign* output, NSError* error)) handler {
    NSMutableString* resourcePath = [NSMutableString stringWithFormat:@"/Designs/upsertWithWhere"];
