 ...
 */
extern NSString *const TWResponseObjectErrorKey;

@interface TWApiClient : AFHTTPSessionManager

@property(nonatomic, assign) NSURLRequestCachePolicy cachePolicy;
@property(nonatomic, assign) NSTimeInterval timeoutInterval;
@property(nonatomic, readonly) NSOperationQueue* queue;

/// In order to ensure the HTTPResponseHeaders are correct, it is recommended to initialize one TWApiClient instance per thread.
@property(nonatomic, readonly) NSDictionary* HTTPResponseHeaders;

@property(nonatomic, strong) id<TWResponseDeserializer> responseDeserializer;

@property(nonatomic, strong) id<TWSanitizer> sanitizer;
/**
 * Clears Cache
 */
+(void)clearCache;
...
/**
 * TWConfiguration return sharedConfig
 *
