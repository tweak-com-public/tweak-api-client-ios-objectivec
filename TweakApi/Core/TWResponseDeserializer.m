#import "TWResponseDeserializer.h"
#import <JSONModel/JSONModel.h>
#import <ISO8601/ISO8601.h>

NSString *const TWDeserializationErrorDomainKey = @"TWDeserializationErrorDomainKey";

NSInteger const TWTypeMismatchErrorCode = 143553;

NSInteger const TWEmptyValueOccurredErrorCode = 143509;

NSInteger const TWUnknownResponseObjectErrorCode = 143528;


@interface TWResponseDeserializer ()
...
@implementation TWResponseDeserializer
...
-(NSError *)typeMismatchErrorWithExpectedType:(NSString *)expected data:(id)data {
    ...
    return [NSError errorWithDomain:TWDeserializationErrorDomainKey code:TWTypeMismatchErrorCode userInfo:userInfo];
}
...
-(NSError *)emptyValueOccurredError {
    ...
    NSDictionary * userInfo = @{NSLocalizedDescriptionKey : message};
    return [NSError errorWithDomain:TWDeserializationErrorDomainKey code:TWEmptyValueOccurredErrorCode userInfo:userInfo];
}
...
-(NSError *)unknownResponseErrorWithExpectedType:(NSString *)expected data:(id)data  {
    ...
    NSDictionary * userInfo = @{NSLocalizedDescriptionKey : message};
    return [NSError errorWithDomain:TWDeserializationErrorDomainKey code:TWUnknownResponseObjectErrorCode userInfo:userInfo];
}
