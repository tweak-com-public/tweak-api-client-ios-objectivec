 ...
 */
extern NSString *const TWDeserializationErrorDomainKey;

/**
 * Code for deserialization type mismatch error
 */
extern NSInteger const TWTypeMismatchErrorCode;

/**
 * Code for deserialization empty value error
 */
extern NSInteger const TWEmptyValueOccurredErrorCode;

/**
 * Error code for unknown response
 */
extern NSInteger const TWUnknownResponseObjectErrorCode;

@protocol TWResponseDeserializer <NSObject>
...
@interface TWResponseDeserializer : NSObject <TWResponseDeserializer>
