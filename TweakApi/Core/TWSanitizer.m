#import "TWSanitizer.h"
#import "TWObject.h"
#import "TWQueryParamCollection.h"
#import <ISO8601/ISO8601.h>

NSString * TWPercentEscapedStringFromString(NSString *string) {
    static NSString * const kTWCharactersGeneralDelimitersToEncode = @":#[]@";
    static NSString * const kTWCharactersSubDelimitersToEncode = @"!$&'()*+,;=";

    NSMutableCharacterSet * allowedCharacterSet = [[NSCharacterSet URLQueryAllowedCharacterSet] mutableCopy];
    [allowedCharacterSet removeCharactersInString:[kTWCharactersGeneralDelimitersToEncode stringByAppendingString:kTWCharactersSubDelimitersToEncode]];
...
- (id) sanitizeForSerialization:(id) object {
    ...
    else if ([object isKindOfClass:[NSString class]] || [object isKindOfClass:[NSNumber class]] || [object isKindOfClass:[TWQueryParamCollection class]]) {
        return object;
    }
    ...
    else if ([object isKindOfClass:[TWObject class]]) {
